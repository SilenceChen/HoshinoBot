...
#抽卡
def get_gecha_equip(gid, uid, gechanum, xnum, dnum, gechainfo):
    equip_list = ''
    CE = CECounter()
    xingchenlist={
        1:1,
    ...
    CE._add_gecha_num(gid, uid, xnum, dnum)
...
def get_card_ce(gid,uid,cid):
    ...
    card_ce=math.ceil((100+fashion_ce+level_ce+favor_ce+equip_ce)*(1+rank/10))
    return card_ce
